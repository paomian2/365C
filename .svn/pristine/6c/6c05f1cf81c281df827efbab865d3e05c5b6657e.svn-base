...
import com.commsdk.common.sdk_qrqcoder.zxing.ScanListener;
...
//		Toast.makeText(that, "result="+rawResult.getText(), Toast.LENGTH_LONG).show();
        ...
        intent.putExtra(Constant.SCAN_RESULT,rawResult.getText());
...
//                    }
                    photo_path= FileUtils.getImageAbsolutePath(CommonScanActivity.this,data.getData());
                    scanManager.scanningImage(photo_path);
            }
        }
    }
