...
public class VerificationCodeTimerUtils extends CountDownTimer {
    private TextView mTextView;

    public VerificationCodeTimerUtils(TextView textView, long millisInFuture, long countDownInterval) {
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundColor(Color.BLACK);  //还原背景色
        this.cancel();
    }
}
