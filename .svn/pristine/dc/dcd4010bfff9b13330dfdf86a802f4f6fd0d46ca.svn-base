...
//	public void addClickListener(final ClickTab clickTab) {
//		tabCount = pager.getAdapter().getCount();
//		for (int i = 0; i < tabCount; i++) {
//			final int position = i;
//			RelativeLayout tab = (RelativeLayout) View.inflate(getContext(), R.layout.personal_tab_item, null);
...
//	}
	...
	private void addTab(final int position, View tab) {
		...
		if (tabCount <= 5 && isAverage()) {
			defaultTabLayoutParams.width = UIHelper.getScreenPixWidth(getContext()) / tabCount; // AppContext
			// .SCREEN_WIDTH/tabCount;
		}
...
//					} else {
//						title.setText(title.getText().toString().toUpperCase(locale));
//					}
//				}
...
//		canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height, rectPaint);
		//设置浮标左右边距 for version 1.0
		//@author Version 1.0 edited by Yu.Yao in 2015/12/15.
		//@version 1.0
