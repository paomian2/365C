...
public class AppActivityManager {
	...
	public void quit(Activity context) {
		...
		//清空Shareprefrence文件
	//	SharedPreferenceUtil.getInstance(context).putString(SharedPreferenceUtil.CUSTBASEINFO,"");
	//	SharedPreferenceUtil.getInstance(context).putString(SharedPreferenceUtil.CUSTBASEINFO_STORE,"");
		cleanActivity();
