...
import com.a365vintagewine.mvp.activity.EaseChatActivity;
...
//                        startActivity(intent);
                        EaseChatActivity.lunch((BaseActivity) getActivity(),username);
                    }
                }else{
                    //平台消息，公司消息，环信平台推送的消息
                }
...
//        });
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        // update unread count
     //   ((LoginActivity) getActivity()).updateUnreadLabel();
        return true;
    }
